...
public class QTEExpensiveRepairs : QuickTimeEvent
{
    private int updateCounter;
    public float percentage;
    public QTEExpensiveRepairs(float duration, float percentage) : base(duration, Manager.m.eventImages[10])
    {
        qteID = 10;
